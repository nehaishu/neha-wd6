...
describe("Todo test suite", () => {
  ...
  test("Creates a todo", async () => {
    ...
    await login(agent, "user.a@test.com", "921404");
  ...
  test("Marking todo as complete", async () => {
    ...
    const dueTodayCount = parsedGroupedResponse.duetodaytodos1.length;
    const latestTodo = parsedGroupedResponse.duetodaytodos1[dueTodayCount - 1];
